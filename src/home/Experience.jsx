            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  ...
                  including the UI of Apple Music’s embeddable web player widget
                  for in-browser user authorization and full song playback.
                </p>
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  Worked with the UI team to engineer and improve major features
                  of Starry’s customer-facing Android app.
                </p>
                <ul className="mt-2 flex flex-wrap" aria-label="Related links">
                  <li className="mr-4">
                    <a
            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  ...
                  websites. Clients included JetBlue, Lovesac, U.S. Cellular,
